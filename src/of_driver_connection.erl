...
init([Socket]) ->
    Protocol = tcp,
    of_driver_utils:setopts(Protocol, Socket, [{active, once}, {nodelay, true}, {buffer, 10000}, {send_timeout, 1500}]), %% , {buffer, 65536} , {send_timeout, 2000}, {send_timeout_close, true}
